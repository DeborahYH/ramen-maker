...
tabs = customtkinter.CTkTabview(root, width=600, height=500, fg_color="white", segmented_button_fg_color="#BEA69F", segmented_button_unselected_color="#BEA69F", segmented_button_selected_color="#9D796F", segmented_button_selected_hover_color="#D8CAC6", segmented_button_unselected_hover_color="#D8CAC6", text_color="#1F1817")
...
radio_s = customtkinter.CTkRadioButton(frame_top1, radiobutton_width=15, radiobutton_height=15, border_width_unchecked=2, border_width_checked=3, font=("Helvetica", 12), text="Small")
radio_s.pack()
radio_m = customtkinter.CTkRadioButton(frame_top1, radiobutton_width=15, radiobutton_height=15, border_width_unchecked=2, border_width_checked=3,font=("Helvetica", 12), text="Medium")
radio_m.pack()
radio_l = customtkinter.CTkRadioButton(frame_top1, radiobutton_width=15, radiobutton_height=15, border_width_unchecked=2, border_width_checked=3,font=("Helvetica", 12), text="Large")
radio_l.pack()

lbl_broth = customtkinter.CTkLabel(frame_top2, font=("Helvetica", 15, "bold", "underline"), text="Soup Base")
lbl_broth.pack(pady=10)

radio_salt = customtkinter.CTkRadioButton(frame_top2, radiobutton_width=15, radiobutton_height=15, border_width_unchecked=2, border_width_checked=3,font=("Helvetica", 12), text="Salt")
radio_salt.pack()
radio_miso = customtkinter.CTkRadioButton(frame_top2, radiobutton_width=15, radiobutton_height=15, border_width_unchecked=2, border_width_checked=3,font=("Helvetica", 12), text="Miso")
radio_miso.pack()
radio_shoyu = customtkinter.CTkRadioButton(frame_top2, radiobutton_width=15, radiobutton_height=15, border_width_unchecked=2, border_width_checked=3,font=("Helvetica", 12), text="Shoyu")
radio_shoyu.pack()
radio_tonkotsu = customtkinter.CTkRadioButton(frame_top2, radiobutton_width=15, radiobutton_height=15, border_width_unchecked=2, border_width_checked=3,font=("Helvetica", 12), text="Tonkotsu")
radio_tonkotsu.pack()
radio_curry = customtkinter.CTkRadioButton(frame_top2, radiobutton_width=15, radiobutton_height=15, border_width_unchecked=2, border_width_checked=3,font=("Helvetica", 12), text="Curry")
radio_curry.pack()
radio_vegetarian = customtkinter.CTkRadioButton(frame_top2, radiobutton_width=15, radiobutton_height=15, border_width_unchecked=2, border_width_checked=3,font=("Helvetica", 12), text="Vegetarian")
...
lbl_spice = customtkinter.CTkLabel(frame_bottom, font=("Helvetica", 12), text="Spiciness Level:")
lbl_spice.pack()
